    ...
    const handleUpdate = async (e) => {
        ...
        try {
            if (pendingPhoto) {
                ...
                const photoRes = await axios.post(`${BASE_URL}/vivrecares-api/upload_profile_photo.php`, fd, {
        ...
        <div className="p-12 bg-[#f4f4f4] min-h-screen">
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
                <div className="w-full md:w-1/3 bg-white p-12 rounded-xl shadow-sm flex flex-col items-center text-center border border-gray-100">
                    ...
                    >
                        {photoUrl ? (
                            <img src={photoUrl} alt="Profile" className="w-full h-full rounded-full object-cover border-2 border-gray-100" />
                        ) : (
