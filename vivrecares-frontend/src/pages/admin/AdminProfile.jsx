        ...
        const fetchCurrentData = async () => {
            ...
            try {
                const res = await axios.get(
                    `${BASE_URL}/vivrecares-api/get_profile.php?user_id=${user.id}`
                );
                // ✅ Fix: unwrap the data envelope
    ...
    return (
        <div className="p-12 bg-[#f4f4f4] min-h-screen">
                    ...
                    <form onSubmit={handleUpdate} className="grid grid-cols-2 gap-8">
                        ...
                        <div className="col-span-2 flex justify-end items-center gap-4 mt-8">
                            ...
                            <button
                                type="submit"
                                disabled={uploading}
                                className="w-16 h-16 bg-[#c4ba9d] rounded-full flex items-center justify-center text-white shadow-lg hover:bg-[#b2a58d] transition disabled:opacity-50"
                            >
                                {uploading ? (
            ...
            <div className="max-w-6xl mx-auto mt-8">
                <PasswordChangePanel roleLabel="Admin" />
            </div>
        </div>
    );
};
