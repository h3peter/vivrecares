        ...
        <div className="flex min-h-screen bg-[#faf9f6] font-sans">
            <aside className="w-64 bg-[#4d4d4d] text-white flex flex-col py-12 sticky top-0 h-screen">
                ...
                <nav className="w-full flex flex-col space-y-1">
                    <SidebarButton label="Patients" active={location.pathname === '/doctor/patients'} onClick={() => handleMenuClick('/doctor/patients')} />
                    <SidebarButton label="Appointments" active={location.pathname === '/doctor/appointments'} onClick={() => handleMenuClick('/doctor/appointments')} />
                    <SidebarButton label="Clinical Reports" active={location.pathname === '/doctor/reports'} onClick={() => handleMenuClick('/doctor/reports')} />
                    <SidebarButton label="My Profile" active={location.pathname === '/doctor/profile'} onClick={() => handleMenuClick('/doctor/profile')} />
                </nav>
